                        ...
                        ->arrayNode('form')
                            ...
                            ->children()
                                ...
                                ->arrayNode('validation_groups')
                                    ...
                                    ->defaultValue(array('Profile', 'Kikolo-Default'))
                                ->end()
                            ->end()
                        ->end()
                    ->end()
                    ...
                    ->children()
                        ...
                        ->arrayNode('form')
                            ...
                            ->children()
                                ...
                                ->arrayNode('validation_groups')
                                    ->prototype('scalar')->end()
                                    ->defaultValue(array('Registration', 'Kikolo-Default'))
                                ->end()
                            ->end()
                        ->end()
                    ->end()
                    ...
                    ->children()
                        ...
                        ->arrayNode('form')
                            ...
                            ->children()
                                ...
                                ->arrayNode('validation_groups')
                                    ->prototype('scalar')->end()
                                    ->defaultValue(array('ResetPassword', 'Kikolo-Default'))
                                ->end()
                            ->end()
                        ->end()
                    ->end()
                    ...
                    ->children()
                        ->arrayNode('form')
                            ...
                            ->children()
                                ...
                                ->arrayNode('validation_groups')
                                    ->prototype('scalar')->end()
                                    ->defaultValue(array('ChangePassword', 'Kikolo-Default'))
                                ->end()
                            ->end()
                        ->end()
                    ->end()
