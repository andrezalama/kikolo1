 ...
 * checks fail.
 *
 * When adding metadata to a class, you can override the "Kikolo-Default" group of
 ...
 *     }
 *
 * Whenever you validate that object in the "Kikolo-Default" group, the group sequence
 * will be validated:
 *
 *     $validator->validate($address);
 *
 * If you want to execute the constraints of the "Kikolo-Default" group for a class
...
class GroupSequence
{
     ...
     * "Kikolo-Default" group. When validating that class in the "Kikolo-Default" group, the
     * group sequence is used instead, but still the "Kikolo-Default" group should be
