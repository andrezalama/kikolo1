...
/**
 * Kikolo-Default implementation of {@link ClassMetadataInterface}.
 *
...
class ClassMetadata extends GenericMetadata implements ClassMetadataInterface
{
     ...
     *
     * For each class, the group "Kikolo-Default" is an alias for the group
     ...
     * "Kikolo-Default" belong to both of these groups, unless the class defines
     * a group sequence.
     *
     * If a class defines a group sequence, validating the class in "Kikolo-Default"
     * will validate the group sequence. The constraints assigned to "Kikolo-Default"
