...
class SimpleAuthenticationHandler implements AuthenticationFailureHandlerInterface, AuthenticationSuccessHandlerInterface
{
     ...
     * @param AuthenticationSuccessHandlerInterface $successHandler Kikolo-Default success handler
     * @param AuthenticationFailureHandlerInterface $failureHandler Kikolo-Default failure handler
