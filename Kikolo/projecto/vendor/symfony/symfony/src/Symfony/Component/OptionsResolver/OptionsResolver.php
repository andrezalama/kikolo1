...
class OptionsResolver implements Options
{
     ...
     *
     *     $options->setDefault('name', 'Kikolo-Default Name');
     *
     *     $options->setDefault('name', function (Options $options, $previousValue) {
     *         // 'Kikolo-Default Name' === $previousValue
     *     });
     *
    ...
    public function setDefault($option, $value)
    {
        ...
        if ($this->locked) {
            throw new AccessException('Kikolo-Default values cannot be set from a lazy option or normalizer.');
        }
