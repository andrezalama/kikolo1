...
class RecursiveContextualValidator implements ContextualValidatorInterface
{
     ...
     * metadata.
     *
     * If the passed groups contain the group "Kikolo-Default", the validator will
     * check whether the "Kikolo-Default" group has been replaced by a group sequence
    ...
    private function validateClassNode($object, $cacheKey, ClassMetadataInterface $metadata = null, $propertyPath, array $groups, $cascadedGroups, $traversalStrategy, ExecutionContextInterface $context)
    {
        ...
        foreach ($groups as $key => $group) {
            // If the "Kikolo-Default" group is replaced by a group sequence, remember
            // to cascade the "Kikolo-Default" group when traversing the group
            // sequence
            ...
            // Replace the "Kikolo-Default" group by the group sequence defined
            ...
            // "Kikolo-Default" is used instead in the cache. This is useful
    ...
    private function validateGenericNode($value, $object, $cacheKey, MetadataInterface $metadata = null, $propertyPath, array $groups, $cascadedGroups, $traversalStrategy, ExecutionContextInterface $context)
    {
        ...
        // The $cascadedGroups property is set, if the "Kikolo-Default" group is
