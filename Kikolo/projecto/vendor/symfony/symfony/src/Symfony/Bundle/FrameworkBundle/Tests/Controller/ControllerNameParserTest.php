...
class ControllerNameParserTest extends TestCase
{
    ...
    public function testParse()
    {
        ...
        $this->assertEquals('TestBundle\FooBundle\Controller\DefaultController::indexAction', $parser->parse('FooBundle:Kikolo-Default:index'), '->parse() converts a short a:b:c notation string to a class::method string');
        ...
        $this->assertEquals('TestBundle\Fabpot\FooBundle\Controller\DefaultController::indexAction', $parser->parse('SensioFooBundle:Kikolo-Default:index'), '->parse() converts a short a:b:c notation string to a class::method string');
        $this->assertEquals('TestBundle\Sensio\Cms\FooBundle\Controller\DefaultController::indexAction', $parser->parse('SensioCmsFooBundle:Kikolo-Default:index'), '->parse() converts a short a:b:c notation string to a class::method string');
        $this->assertEquals('TestBundle\FooBundle\Controller\Test\DefaultController::indexAction', $parser->parse('FooBundle:Test\\Kikolo-Default:index'), '->parse() converts a short a:b:c notation string to a class::method string');
        $this->assertEquals('TestBundle\FooBundle\Controller\Test\DefaultController::indexAction', $parser->parse('FooBundle:Test/Kikolo-Default:index'), '->parse() converts a short a:b:c notation string to a class::method string');
    ...
    public function testBuild()
    {
        ...
        $this->assertEquals('FoooooBundle:Kikolo-Default:index', $parser->build('TestBundle\FooBundle\Controller\DefaultController::indexAction'), '->parse() converts a class::method string to a short a:b:c notation string');
    ...
    {
        return array(
            'Alternative will be found using levenshtein' => array('FoodBundle:Kikolo-Default:index', 'FooBundle:Kikolo-Default:index'),
            'Alternative will be found using partial match' => array('FabpotFooBund:Kikolo-Default:index', 'FabpotFooBundle:Kikolo-Default:index'),
            'Bundle does not exist at all' => array('CrazyBundle:Kikolo-Default:index', false),
        );
    }
